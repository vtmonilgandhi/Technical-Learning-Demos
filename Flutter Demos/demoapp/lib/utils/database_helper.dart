...
class DatabaseHelper {
  ...
  final String tableUser = "usersTable";
  ...
  void _onCreate(Database db, int version) async {
    await db.execute(
        "CREATE TABLE $tableUser($columnId INTEGER PRIMARY KEY, $columnUsername TEXT, $columnPassword TEXT, $columnEmail TEXT, $columnBirthday TEXT, $columnCity TEXT)");
  }
